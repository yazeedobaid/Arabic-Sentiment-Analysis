...
if __name__ == "__main__":
    ...
    posReview = "synopsis : bobby garfield ( yelchin ) lives in a small town with his mirthless widowed mother " \
                "( hope davis ). bobby's world revolves around his friends , especially the spritely carol ( boorem ) ." \
                "then one day , a new boarder arrives at bobby's house . ted brautigan ( hopkins ) is an enigmatic man " \
                "to whom bobby takes an immediate liking ."
    print(posReview)
